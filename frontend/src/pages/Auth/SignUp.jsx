      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
        ...
        >
          ...
          <p className="text-gray-600 mb-4">
            Welcome to Job Kita! Your account has been successfully created.
          </p>
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-blue-100 to-blue-300 text-white py-3 rounded-lg font-semibold hover:from-blue-500 hover:to-blue-700 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
          >
            {formState.loading ? (
              <>
