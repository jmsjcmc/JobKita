...
import { Briefcase, CheckCircle2, Icon, TrendingUp, Users } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto space-y-8 mb-96">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            headerAction={
              ...
              onClick={() => navigate('/manage-jobs')}>View all</button>
            }>

              <div className="space-y-3">{dashboardData?.data?.recentJobs
                ?.slice(0,3)
                ?.map((job, index) => (
