        ...
        <div className="max-w-7xl mx-auto space-y-8 mb-96">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <button key={index} className="flex items-center space-x-3 p-4 rounded-xl border border-gray-100 hover:border-gray-200 hover:shadow-sm transition-all duration-200 text-left" onClick={() => navigate(action.path)}>
