import { Award, BarChart3, Building2, Clock, FileText, LayoutDashboard, MessageSquare, Plus, Search, Shield, User } from "lucide-react";
...
export const NAVIGATION_MENU = [
    ...
    {id: "manage-jobs", name: "Manage Jobs", icon: Building2},
...
export const CATEGORIES = [
    ...
    {value: "Customer-service", label: "Customer Support"},
